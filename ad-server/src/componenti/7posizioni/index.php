...
$command = getpost("op", "", ["modifica","modificaStep2reload","modificaStep2","eliminaSelezionati","aggiungi","aggiungiStep2reload","aggiungiStep2"]);
$parameter = (int)getpost("id", 0);
$combotipo = get("combotipo", $session->get($obj->tbdb."combotipo") ?: "-999", ["-999","CPC","CPD","CPM"]);
$keyword = get("keyword",$session->get($obj->tbdb."keyword"));
